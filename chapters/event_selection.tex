...
The energies of reconstructed muons were corrected before applying any selections.  Muon energy 
corrections were derived by comparing muon kinematic variables in $Z \rightarrow \mu\mu$ decays 
between data and simulated events.  The corrections were applied to resolve the difference in 
muon $\pt$ selection efficiency between data and simulated events.

Following energy corrections, muon kinematic and identification selections were applied to select muons consistent 
...
with $\mWR > 2$ $\TeV$, as shown in Table \ref{tab:lowerMuonPtCuts}.  Muons that passed kinematic 
selections were filtered with the following identification selections:
...
If an event contained more than two muons that passed all kinematic and identification selections, the two 
...
The energies of reconstructed electrons were corrected before applying any selections.  Electron energy 
corrections were derived by comparing electron kinematic variables in $Z \rightarrow ee$ decays 
between data and simulated events.  The corrections were applied to resolve the difference in electron $\Et$ 
selection efficiency between data and simulated events.

Following energy corrections, electron kinematic and identification selections were applied to select electrons 
...
Electrons that passed kinematic selections were filtered with the following identification selections:
...
If an event contained more than two electrons that passed all kinematic and identification selections, the two 
