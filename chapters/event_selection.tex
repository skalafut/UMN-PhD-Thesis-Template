...
\mWR produced leptons and jets with several hundred $\GeV$ or more of $\pt$ or $\Et$, as shown in 
...
additional distinguishing features of \WR and \nul decays.  To conserve momentum in the $\WR \rightarrow \ell_{1} \nul$ 
decay, the charged lepton $\ell_{1}$ recoiled against the heavier neutrino \nul.  Then the \nul decayed to a 
second charged lepton $\ell_{2}$ and two jets, which all recoiled against $\ell_{1}$.  Thus the lepton pair $\ell_{1}\ell_{2}$, 
...
$\GeV$ or more, needed to predict low ST neutrino masses resulted in large $(\eta, \phi)$ separations 
between $\ell_{2}$ and both jets, as shown in Figure \ref{fig:wrSubleadLeptJetSeparation}.  Meanwhile, \DY 
and diboson (WW, WZ, ZZ) background events were concentrated in the $\Mll < 180 \GeV$ region.  Also, in 
multi-jet (QCD) background events with a reconstructed lepton, the lepton was often close to a reconstructed 
jet.  The $(\eta, \phi)$ separation between leptons and jets, and the recoil of $\ell_{1}$ against $\ell_{2}$ 
motivated additional event selections:
...
No jet reconstruction or ID selection weights were needed because the reconstruction and ID selection efficiencies were 
the same in data and simulated events within uncertainties.
...
\begin{itemize}
	\item Each selected lepton was separated from the other lepton and both selected jets by $\Delta R > 0.4$.
...
The full trigger, kinematic, and ID selection efficiency in \WR signal events exceeded 50\% (70\%) in the $ee$-channel 
($\mu\mu$-channel), as shown in Figure \ref{fig:wrRecoSelectionEff}.  The efficiency was lower in the $ee$-channel due 
to the gap in electron detection for $1.44 < |\eta| < 1.57$, and tighter ID selections for electrons relative to muons.  
