...
Muons reconstruction began with the reconstruction of tracks in the muon chambers and silicon tracker.  
...
In the search presented here, the momenta of reconstructed muons were determined using the "TuneP" algorithm 
...
in all muon chambers to determine the muon momentum.  The third algorithm used only the first layer of muon 
chambers closest to the magnet solenoid .
