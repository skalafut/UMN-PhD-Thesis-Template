...
heavy neutrinos.  During collisions, events are selected using the trigger. %"HLT_DoubleEle33_CaloIdL_GsfTrkIdVL"
As explained in Chapter \ref{sec:experiment_chapter}.
