...
In the $\mu\mu$-channel, events were first selected by a Level-1 trigger that required a track segment in at least one muon DT or 
...
%RESUME HERE
%include trigger pT turn-on curves to show that offline pt cuts are above trigger turn-on curves
%also quote electron and muon energy resolutions in the selected kinematic region, see Offline Jet Selection section for an example
