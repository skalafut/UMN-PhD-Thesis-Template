...
to be the same in the $\Meejj$ and $\Mmumujj$ distributions.  The shape of the top quark background $\Mlljj$ 
distribution in different lepton channels was studied using simulated top quark background events.  Simulated 
...
independent of $\Mlljj$, within the statistical uncertainty of each bin.  The flat ratios indicated that the 
...
The $\Memujj$ distribution found in simulated top quark events differed from the $\Meejj$ and $\Mmumujj$ 
distributions by a factor equal to the difference in $e\mu$ and $\ell\ell$ production rate, and the difference 
in acceptance, trigger efficiency, and reconstruction and selection efficiency between electrons and muons.  
The production rates are $ee/e\mu \thickspace = \thickspace \mu\mu/e\mu \thickspace = \thickspace 0.5$, 
and the difference between electron and muon acceptance $\times$ efficiency forced the ratios $ee/e\mu$ and 
$\mu\mu/e\mu$ after all selections away from 0.5, in opposite directions. 
%RESUME HERE%
In general this factor is $\pt$ and $\eta$ dependent, 
but for the high energy, central leptons used in the \WR search, the factor is a constant independent 
of kinematic variables.  The .
