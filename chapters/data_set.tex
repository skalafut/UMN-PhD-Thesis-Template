...
of the signal and the backgrounds.  The background predictions were further refined by comparing the background simulations 
to the data in kinematic control regions where the simulations were expected to agree with the data.
...
In the first step one \MC generator simulated the hard interaction, like $pp \rightarrow \WR \rightarrow \ell\ell jj$, 
