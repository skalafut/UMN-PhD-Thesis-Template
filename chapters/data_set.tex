...
In the first step one or two \MC generators simulated the hard interaction, like $pp \rightarrow \WR \rightarrow \ell\ell jj$, 
between protons colliding in a vacuum, the decay of unstable particles, and the hadronization of final state partons 
into jets.  Partons were always hadronized into jets using the \PYTHIA generator \cite{pythia8,Sjostrand:2006za}, but 
different generators were used based on their respective strengths and characteristics of the hard interaction that was 
simulated.  The \MADGRAPH generator \cite{madgraph}.


%POWHEG generator \cite{powheg}
