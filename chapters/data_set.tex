...
the $ee$- and $\mu\mu$-channel requirements described previously.  Selected events defined the shape of the $\Mlljj$ distribution in both 
channels, but the magnitude was adjusted based on comparisons between simulations and data in three control regions.
...
The diboson (WW, WZ, ZZ) and W+jets interactions produced $\ell\ell jj$ events at a much lower rate than the $\DY$+jets interaction.  The 
$\Mlljj$ distribution produced by these interactions was estimated using simulated diboson and W+jets events.  Simulated events were 
selected using the selection criteria described in Chapter \ref{sec:reco_chapter}.  The $\Mlljj$ distribution found in diboson and W+jets 
events (Figure \ref{fig:allExpectedBkgnds}) was less than 3\% of the total $\DY$+jets $\plus$ top quark backgrounds, and did not extend 
above $\Mlljj = 2.0$ $\TeV$.  For these reasons, the contribution of diboson and W+jets backgrounds to the $\Mlljj$ distribution found in 
data were neglected.
