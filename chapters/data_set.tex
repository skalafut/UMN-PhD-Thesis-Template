...
jets.  Unlike \DY, interactions that produced single top quarks (Figure \ref{fig:singleTopDiags}) and $t\bar{t}$ quark pairs 
(Figure \ref{fig:ttbarDiag}) produced $\ell\ell jj$ final states with no initial state parton radiation.  Collectively the 
single top quark and $t\bar{t}$ interactions produce the top quark background, and $t\bar{t}$ production is the dominant 
contributor.  The $t\bar{t}$ interaction produced two leptons and two jets with a cross section $\times$ branching ratio of 
86 pb, similar to the 6000 pb \DY cross section $\times$ branching ratio weighted by the 1\% probability to radiate two partons.  
The only other interactions that produce two leptons and jets without initial state parton radiation are the WZ and ZZ 
interactions.  WZ production creates two leptons and jets when the $W$ decays hadronically, and the $Z$ decays to charged 
leptons.  ZZ production creates two leptons and jets when one $Z$ decays hadronically, and the other decays to charged leptons.  
However, the combined WZ and ZZ interactions produced $\ell\ell jj$ final states in the detector with a cross section $\times$ branching 
ratio of $\sim$3 pb, so the WZ and ZZ background was negligible.  The WW interaction produces two charged leptons with a 
cross section $\times$ branching ratio of 12 pb.  The initial state partons that produce the WW pair can radiate a parton 
with a $\sim$10\% probability, so the WW interaction produced two leptons and jets in the detector with cross section $\times$ 
branching ratio of $\sim\frac{12}{100} = $ 0.1 pb, negligible compared to $\DY$+jets and $t\bar{t}$.  The interactions that 
radiate partons and produce a $W$ boson, and QCD multi-jet interactions contribute to the $\Mlljj$ distribution found in data 
only when jets are incorrectly reconstruct as leptons.
...
%RESUME HERE
%review this again, take out any information about cross section times branching ratio that was explained previously
