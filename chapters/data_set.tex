...
QCD multi-jet interactions produced $\ell\ell jj$ events at a rate that was expected to be much lower than the $\DY$+jets interaction.  
Unlike events produced by the other background interactions, QCD interactions produced .

In those events, two real 
