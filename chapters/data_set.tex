...
Knowing the top quark background shape was identical in all lepton channels, the top quark background magnitude in 
...
%selection efficiency\footnote{For example, muons were reconstructed in the region $1.44 < |\eta| < 1.57$ 
%where electrons could not be reconstructed.}, and they caused the $ee:e\mu$ and $\mu\mu:e\mu$ NFs to differ from 0.5.  
...
%calculated using all events with $\Mlljj > 600$, but were dominated by simulated events with $\Mlljj < 1500$ $\GeV$ 
...
The top quark contribution to the $\Mlljj$ distribution found in data was estimated by multiplying the $\Memujj$ 
