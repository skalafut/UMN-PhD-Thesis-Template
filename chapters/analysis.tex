...
as shown in Figure \ref{fig:signalShapesAfterSelection}.  %These signal characteristics motivated the use of 
%finite size $\Mlljj$ windows to search for evidence of a \WR and \nul.
...
%second paragraph
%After all selections the estimated ST backgrounds were cha.
