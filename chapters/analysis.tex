...
due to all energy and lepton ID uncertainties.  In the $\Mlljj$ windows linked to signals that have $\mWR \geq 2$ $\TeV$, 
the effect of the energy and ID uncertainties was an uncertainty of $\lesssim$4\% on the signal prediction, and larger 
...
%describe how uncertainties change with the Mlljj window
%RESUME HERE
...
%describe how uncertainties change with Mlljj window
%RESUME HERE
