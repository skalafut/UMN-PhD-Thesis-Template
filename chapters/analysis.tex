...
when calculating the search results their effects were included as percentage uncertainties on 
the expected number of events in each window.

The impact of lepton and jet energy uncertainties was estimated simultaneously with the impacts of 
the statistical uncertainty and simulated lepton ID uncertainties, but ignoring other 
...
Only the effect of lepton and jet energy uncertainties could cause an event to suddenly pass (fail)
the selection when, without these uncertainties, the event failed (passed) the selection, or cause an 
event to pass the selection and migrate to a different $\Mlljj$ window.  The effect of statistical 
uncertainty was estimated simultaneously with energy uncertainties because the statistical uncertainty 
depended on the number of events in each $\Mlljj$ window.  The effect of lepton ID uncertainties, which 
only affected simulated events, was estimated at the same time simply out of convenience, and had no 
...
analyses.  These uncertainties and a brief description of them are listed in Table \ref{}.
...
$e\mu$ data events that represented the top quark background:
...
By repeating this procedure 3200 times for every event, the uncertainty on the number of expected 
background and signal events due to energy and ID uncertainties was estimated, and shown in Table 
\ref{tab:impactOfEnergyIdUncerts} for one typical \mWR hypothesis.  DISCUSS STAT UNCERTAINTY


\begin{table}[ht]
	\caption{Impact of lepton and jet energy and lepton ID uncertainties on expected signal and background event counts in the $\Mlljj$ 
		window for the $\mWR = 2.2\TeV$ hypothesis.  All uncertainties were in percentages of expected events.  The lepton uncertainty 
	for the Top quark backgrounds combined the electron and muon uncertainties in $e\mu$ data, but this uncertainty combination was 
	not done for \DY or \WR simulations.}
  \label{tab:impactOfEnergyIdUncerts}
  \centering
    \begin{tabular}{c|c|c|c}
		Process & Uncertainty sources    & Uncertainty on number of $eejj$ events (\%) & Uncertainty on number of $\mu\mu jj$ events (\%)  \\
      \hline
	  \WR & lepton energy and ID & $1$ & $3$ \\ 
	  \WR & jet energy & $1$ & $1$ \\ 
	  \DY &  lepton energy and ID & $4$ & $7$  \\
	  \DY &  jet energy & $14$ & $11$  \\
	 Top quark backgrounds & lepton energy & $8$ & $8$ \\
	 Top quark backgrounds & jet energy & $2$ & $2$  \\
  \hline
  \end{tabular}
\end{table}
