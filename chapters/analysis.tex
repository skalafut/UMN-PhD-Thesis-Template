...
The pileup weights $w_{PU}$ applied to simulated events were derived assuming the vertex reconstruction 
efficiency in data was parameterized by .

%The pileup weights $w_{PU}$ applied to simulated events were derived assuming the pileup distribution in data 
%followed a specific shape, which was sensitive to the performance of vertex reconstruction in the tracker.  
