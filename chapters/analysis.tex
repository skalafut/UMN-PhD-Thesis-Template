...
As \DY and \WR expected event counts are estimated from simulated events, these estimates were subject 
to three additional uncertainties that did not effect the top quark background estimate: cross 
section uncertainty, pileup uncertainty, and parton distribution function (PDF) uncertainty.  The 
effect of all three uncertainties was estimated using techniques approved by the CMS Collaboration, 
and quantified as an uncertainty on the expected number of events.
