...
events, and this uncertainty depended on the $\Mlljj$ window.  Increasing .  In the $\Mlljj$ windows linked to signals that have $\mWR \geq 2$ $\TeV$, 
the energy and ID uncertainties resulted in an uncertainty of $\lesssim$4\% on the signal prediction, and larger 
uncertainties on the background prediction (Table \ref{tab:impactOfEnergyIdUncerts}).  The uncertainty on the background 
prediction changed with the $\Mlljj$ window.  These uncertainties were included 
in limit calculations using Gamma distributions for the marginal posterior distributions.

%As MWR increases from 1.8 to 4 TeV the WR unc remains constant - 1\% in ee chnl and 3\% in mumu chnl
%As MWR increases from 1.8 to 4 TeV the DY unc, dominated by the jet energy unc, increases from 10\% to 20\% in both channels
%As MWR increases from 1.8 to 4 TeV the top quark unc, dominated by the muon energy unc, increases from 14\% to 53\% in both channels
%RESUME HERE
...
luminosity of the data, and as a result have positive weights less than 1.  In the $\Mlljj$ windows linked to signals 
that have $\mWR \geq 2$ $\TeV$, the statistical uncertainty was $<$2\% on the signal prediction, $\geq$5\% on the \DY 
background prediction, and $>$30\% on the top quark background prediction (Table \ref{tab:impactOfStatUncert}).  These 
uncertainties were included in limit calculations by using Gamma distributions for the marginal posterior distributions.

%As MWR increases from 1.8 to 4 TeV the WR stat unc is constant at 1\%
%As MWR increases from 1.8 to 4 TeV the DY stat unc increases from 10\% to 13\%
%As MWR increases from 1.8 to 4 TeV the top qrk stat unc increases from 38\% to 100\%
%RESUME HERE
