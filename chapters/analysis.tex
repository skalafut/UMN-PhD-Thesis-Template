...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The selections described in Chapter \ref{sec:event_selection_chapter} were applied to data, and 
...
of events relative to estimated backgrounds.  The window sizes were optimized and the results were 
...
In general, cross section $\times$ branching fraction limits are calculated using .

Limits on the \WR cross section $\times$ branching fraction to $\ell\ell jj$ final states were 
calculated in two scenarios: ``expected'' limits where the number of selected events equaled the 
number of estimated background events, and ``observed'' limits where the number of .
