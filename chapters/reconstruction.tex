...
reconstruction algorithms fitted four continuous tracks to silicon tracker and muon detector hits 
to estimate the muon's trajectory through all of CMS \cite{cmsMuonRecoRunTwo}.  Each algorithm combined 
