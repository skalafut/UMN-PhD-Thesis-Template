...
%RESUME HERE this top quark bkgnd paragraph is poorly written
Each top quark produced in pp interactions decays promptly to one bottom quark and one $W^{\pm}$ boson.  Both the $W$ and bottom quark 
can decay to a charged lepton.  In events where one or more top quarks are created by any top quark process, the $\ell\ell jj$ 
