...
i separated from the jet axis j by $\Delta R(i,j)$, this parameter weights the likelihood of clustering particle i into the jet by 
$(\frac{0.4}{\Delta R(i,j)})^{2}$.  Thus, the parameter $R$ puts a soft limit on each jet's $(\eta,\phi)$ area.  However, it is 
possible for a reconstructed particle to be clustered into a jet and be separated from the jet axis by $\Delta R > 0.4$.  To avoid 
selecting a lepton reconstructed near a jet, each reconstructed lepton that passed the identification, $\pt$, and $\eta$ selection 
criteria was required to be separated from both selected jets by $\Delta R > 0.4$.
...
The lepton and jet selections described earlier .
