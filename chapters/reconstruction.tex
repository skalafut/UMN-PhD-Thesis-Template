...
and $\ell$ are emitted isotropically.  In addition, due to the large expected \mWR, the final state leptons and jets are produced with 
high $\pt$ (Figure \ref{fig:wrLeptJetPts}) and low $\eta$ (Figure \ref{fig:wrLeptJetEtas}).

%now shift discussion to kinematics affected by \mnul
...
\begin{figure}[btp]
	\centering
	\subfigure{
		\includegraphics[width=0.4\textwidth]{figures/etaMatchedRecoEleFromWr_mwr2200_mnu1100.pdf}
		\caption{e from $\WR \rightarrow e\nul$}
	}
	\subfigure{
		\includegraphics[width=0.4\textwidth]{figures/etaMatchedRecoEleFromNu_mwr2200_mnu1100.pdf}
		\caption{e from $\nul \rightarrow ejj$}
	}
