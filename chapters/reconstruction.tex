...
\begin{figure}
	...
	\end{subfigure}
	\caption{The $\pt$ distribution of leptons and jets reconstructed in $\WR \rightarrow \ell\ell jj$ events with $\mWR = 2.2$ $\TeV$ 
...
\begin{figure}
	...
	\end{subfigure}
	\caption{The $\eta$ distribution of leptons and jets reconstructed in $\WR \rightarrow \ell\ell jj$ events with $\mWR = 2.2$ $\TeV$ 
...
\begin{figure}
	...
	\end{subfigure}
	\caption{The $\pt$ distribution of leptons and quarks produced in $\WR \rightarrow \ell\ell qq$ events with $\mWR = 2.2$ $\TeV$ 
...
\begin{figure}
	...
	\end{subfigure}
	\caption{The $\Delta R(\ell,q)$ separation distribution between the $\ell$ and both quarks produced in $\nul \rightarrow \ell qq$ 
