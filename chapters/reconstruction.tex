...
\label{sec:muReco}
Muons are first reconstructed as tracks from signals measured in the muon chambers.  In each DT chamber, the start and end points of 
...
practice, more than one 3D track is reconstructed in a DT chamber in less than 1\% of events \cite{cmsTdrPhysPerformance}.  In each CSC 
chamber, the .
...
%the Kalman filter used to build tracks in the muon detectors applies a chi2 < 20 cut to each new signal (1 DOF)
