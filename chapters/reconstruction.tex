...
\begin{itemize}
	...
	\item Each electron was promptly produced, and was not reconstructed inside a jet or near other particles.
	\item The track of each electron was reconstructed from multiple high quality measurements made in the tracker.
\end{itemize}

\textbf{Muons}
\begin{itemize}
	\item Each muon had an $|\eta| < 2.$, and at least one muon had a $\pt > 50$ $\GeV$.
...
Having selected events for this search, the leptons and jets were required to pass additional selection criteria that are based on 
...
to leptons and quarks that hadronize into jets.
