...
The \DY+jets process produces events with $\ell\ell jj$ final states that are characterized by low $\Mll$, and low energy jets.  Due 
to the $Z$ boson resonance the vast majority of \DY lepton pairs are produced with $60 < \Mll < 120$ $\GeV$.  The upper bound of 
$\Mll < 120$ $\GeV$ constrains both leptons to have $\pt \lesssim 60$ $\GeV$.  The jets produced in .

This $\Mll$ constraint 
limits the lepton $\pt$ to below 60 $\GeV$.  .

%see Sept 2015 for kinematic plots with MWR = 2.6 TeV MNu = 1.3 TeV overlaid on TTBar and DY+jets after all selections

%for the partons produced in DY+jets events
%The radiated parton energies and trajectories are only correlated with the final state leptons insofar as the \DY+jets system 
%$\pt$ must be conserved
