...
\usepackage{tikz} % Add tikz package for vector graphics
...
\includeonly{
	...
	chapters/app_trgOfflId,
	chapters/app_bayesLimits,
}
...
\include{chapters/app_trgOfflId}
\include{chapters/app_bayesLimits}
