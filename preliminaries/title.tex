...
\title{\bf Search for a Heavy Right-Handed W Boson and Heavy Right-Handed Neutrino of the Left-Right Symmetric Extension of the Standard Theory}
\author{Sean Thomas Kalafut}
% Advisor name, put co-advisors here as well separated by commas
\director{Professor Roger W. Rusack}
